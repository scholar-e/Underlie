...
if __name__ == "__main__":
    ...
    parser.add_argument("--brain-api-url", default=None,
                        help="URL of the remote brain server (e.g. https://xxx.ngrok-free.dev)")
    args = parser.parse_args()

    if args.brain_api_url:
        os.environ["BRAIN_API_URL"] = args.brain_api_url

    if not os.environ.get("BRAIN_API_URL"):
        print("Using default BRAIN_API_URL=https://headsman-zips-antacid.ngrok-free.dev (set BRAIN_API_URL env var to override)")
        os.environ["BRAIN_API_URL"] = "https://headsman-zips-antacid.ngrok-free.dev"
